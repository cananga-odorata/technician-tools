        ...
        <div class="min-h-screen flex items-center justify-center bg-primary transition-colors duration-300 relative">
            ...
            <div class="bg-secondary p-8 rounded-2xl shadow-xl w-full max-w-md border border-border-primary">
                <div class="text-center mb-8">
                    ...
                    <h1 class="text-2xl font-bold text-text-primary">{t("technician_login")}</h1>
                    <p class="text-text-tertiary mt-2">{t("enter_credentials")}</p>
                </div>

                <form onSubmit={handleLogin} class="space-y-6">
                    <div>
                        <label class="block text-sm font-medium text-text-secondary mb-2">{t("username")}</label>
                        <input
                            type="text"
                            value={username()}
                    ...
                    <div>
                        <label class="block text-sm font-medium text-text-secondary mb-2">{t("password")}</label>
                        <input
                            type="password"
                            value={password()}
