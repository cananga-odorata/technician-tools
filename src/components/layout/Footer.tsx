        ...
        <footer class="bg-gray-800 text-white mt-auto">
            <div class="max-w-7xl mx-auto px-4 py-8">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {/* Column 1 */}
                    <div>
                        <h2 class="text-lg text-blue-600 font-semibold mb-4">About Us</h2>
                    ...
                    {/* Column 2 */}
                    <div>
                        <h3 class="text-lg text-blue-600 font-semibold mb-4">Quick Links</h3>
                        <ul class="space-y-2 text-sm">
                            ...
                            <li><a href="/terms" class="text-gray-500 hover:text-white transition">Term</a></li>
                            <li><a href="/login" class="text-gray-500 hover:text-white transition">Login</a></li>
                        </ul>
                    </div>

                    {/* Column 3 */}
                    <div>
                        <h3 class="text-lg text-blue-600 font-semibold mb-4">Contact Info</h3>
